...
//Name: ball.ma
//Last modified: Wed, Mar 20, 2019 06:05:52 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 20.680714949104292 33.933565226740789 -62.146900868433463 ;
	setAttr ".r" -type "double3" -26.738352729603687 -194.19999999997464 0 ;
	setAttr ".rp" -type "double3" 2.7755575615628914e-16 4.4408920985006262e-16 0 ;
	setAttr ".rpt" -type "double3" -3.4866673549091039e-15 1.7236908469012767e-15 8.396851032218478e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "A04AEADB-4B8C-7C93-EF73-E99A906182B1";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 73.266669753486383;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 4.6296895374512772 0.96965199708773753 1.2861339366899891 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "77A51A71-41FC-89DC-EF7D-1A92C39E1EC7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 14.730546426435508 1000.1 18.816391420629301 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "7822B811-4E86-F306-CE77-E9A260F06F45";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 993.84068554396424;
	setAttr ".ow" 89.28948719985307;
	setAttr ".imn" -type "string" "top";
	setAttr ".den" -type "string" "top_depth";
	setAttr ".man" -type "string" "top_mask";
	setAttr ".tp" -type "double3" 14.730546426435508 6.2593144560357814 18.816391420629078 ;
...
createNode transform -n "pCube1";
	...
	setAttr ".t" -type "double3" 0 6.0640359009133586 1.9542306339702558 ;
	setAttr ".s" -type "double3" 35.291007300813753 10.033596405877418 27.425163887260421 ;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 8 ".pt[0:7]" -type "float3"  -0.097644806 -0.097644806 
		0.097644806 0.097644806 -0.097644806 0.097644806 -0.097644806 0.097644806 0.097644806 
		0.097644806 0.097644806 0.097644806 -0.097644806 0.097644806 -0.097644806 0.097644806 
		0.097644806 -0.097644806 -0.097644806 -0.097644806 -0.097644806 0.097644806 -0.097644806 
		-0.097644806;
	setAttr ".bck" 3;
...
createNode transform -n "pCube7";
	...
	setAttr ".t" -type "double3" 20.245050814222818 4.6643024071947936 -3.7757675433865465 ;
	setAttr ".s" -type "double3" 1.3387333922849454 9.1589560685060665 7.9912084286838967 ;
...
createNode transform -n "pCube8";
	...
	setAttr ".t" -type "double3" -3.6227204850237769 3.0753250946677775 15.902770870927394 ;
...
createNode transform -n "pSphere1";
	...
	setAttr ".t" -type "double3" -14.841170189303028 5.0707821780634683 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EFFDC655-4F0A-ABC7-A901-16ACCD0F061B";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "EF5724DA-4F24-6CFE-E9C1-A4AE3FF68F5A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "34722A44-49A9-E57B-5915-948A7932A357";
createNode displayLayerManager -n "layerManager";
	rename -uid "EFE2AFA2-48E3-809A-158F-66952F91FF3D";
createNode displayLayer -n "defaultLayer";
	rename -uid "9AA46811-4A50-48E8-DB39-4A871DD98438";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1F3E82B0-45EF-DE40-F3DF-9FB03261E774";
